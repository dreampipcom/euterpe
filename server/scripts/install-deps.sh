...
log "dp::euterpe::ci::(busy):: Installing dependencies: K3S and Kompose." 2
if [[ "$(which kompose)" == "" ]]; then
    curl -L https://github.com/kubernetes/kompose/releases/download/v1.35.0/kompose-linux-amd64 -o kompose
fi
else
  log "dp::euterpe::ci::(skip)::skipped installing deps."
fi




log "dp::euterpe::ci::(idle)::all good." 0